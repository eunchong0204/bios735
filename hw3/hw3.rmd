...
writing and exporting a wrapper R function (e.g. adding a `@export`tag). 

Remember to include the following at the top of your C++ script 
(you do not include `Rcpp.h` because `RcppArmadillo.h` includes this). As
