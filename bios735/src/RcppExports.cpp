...
// random_walk2
List random_walk2(double niter, double lambda);
RcppExport SEXP _bios735_random_walk2(SEXP niterSEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type niter(niterSEXP);
    Rcpp::traits::input_parameter< double >::type lambda(lambdaSEXP);
    rcpp_result_gen = Rcpp::wrap(random_walk2(niter, lambda));
...
RcppExport SEXP _bios735_col_ridge2(SEXP YSEXP, SEXP XSEXP, SEXP lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(col_ridge2(Y, X, lambda));
    return rcpp_result_gen;
END_RCPP
}
// one_or_exp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bios735_col_ridge2", (DL_FUNC) &_bios735_col_ridge2, 3},
